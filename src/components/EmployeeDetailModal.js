...
function EmployeeDetailModal({ employee, onClose, mode = 'view' }) {
...
//         try {
//             const response = await fetch(
//                 `${API_URL}/api/employees/${employee.id}/upload-photo`,  // ← 修正
//                 {
//                     method: 'POST',
//                     body: formData
//                 }
...
//         try {
//             const response = await fetch(
//                 `${API_URL}/api/employees/${employee.id}`,  // ← 修正
//                 {
//                     method: 'PUT',
//                     headers: {
//                         'Content-Type': 'application/json'
...
//                             {displayEmployee.details?.photoUrl ? (
//                                 <img
//                                     src={`${API_URL}${displayEmployee.details.photoUrl}`}  // ← 修正
//                                     alt={`${displayEmployee.name}のプロフィール写真`}
//                                 />
//                             ) : (
//                                 <div className="employee-detail-profile-photo-placeholder">
